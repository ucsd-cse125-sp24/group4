...
void Model::loadAnimationFromPath(AnimationState state, const std::string &path)
{
    ...
    //             int boneIndex = skeleton.addBone(boneName, boneOffset);
    //             std::cout << "Bone added: " << boneName << " with index " << boneIndex << " and offset matrix: " << glm::to_string(boneOffset) << std::endl;
    //         }
    //     }
    // }
        ...
        //         {
        //             boneIndex = skeleton.addBone(boneName, boneOffset);
        //             // std::cout << "Bone added: " << boneName << " with index " << boneIndex << std::endl;
        //         }
        //         else
        //         {
        //             boneIndex = skeleton.getBoneIndex(boneName);
        ...
        //             // std::cout << "Adding weight " << weight << " to vertex " << vertexID << " for bone " << boneName << std::endl;
        //             meshData.addBoneData(vertexID, boneIndex, weight);
        //         }
        //     }
        // }
    ...
    void Model::process_node(aiNode * node, const aiScene *scene)
    {
        ...
        for (unsigned int i = 0; i < node->mNumMeshes; i++)
        {
            ...
            std::cout << "Mesh added from node: " << node->mName.C_Str() << std::endl;
        }
